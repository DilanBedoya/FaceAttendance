...
describe("Asistencias test", () => {
        ...
        render(
            <MemoryRouter initialEntries={["/login"]}>
                <Routes>
                    ...
                    <Route path="/dashboard/*" element={<Asistencias />} />
                </Routes>
            </MemoryRouter>
        );
    ...
    test("Mostrar título de la página", () => {
        expect(screen.getByText(/Gestionar Asistencias/i)).toBeDefined();
    });

    test("Visualizar estudiantes del curso seleccionado", async () => {
