...
describe("Actuaciones test", () => {
    ...
    test("Visualizar estudiantes con sus respectivas actuaciones", async () => {
        ...
        await waitFor(() => {
            ...
            const messange = screen.getByText(/Actuaciones durante el semestre/i);
